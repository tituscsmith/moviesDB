...
<section class="container grey-text">
    <h4 class="center" >Search for a Movie by Country!</h4>
    <form name="myForm" class="white" action="search-by-country-result.php" onsubmit="return validateForm()" method="POST">
